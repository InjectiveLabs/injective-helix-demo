  ...
  home: {
    ...
    faq: {
      ...
      accordion2: {
        ...
        feature1: {
          section1: 'Trade top crypto pairs on',
          section2: 'Spot Markets'
        },
        feature2: {
          section1: 'Use up to',
          ...
          section5: 'stocks',
          section6: 'commodities',
          section7: 'like gold and silver.'
        },
        feature3: {
          section1: 'Automate your strategies with built-in ',
          section2: 'trading bots',
          section3: 'for spot and perpetual markets.'
        },
        feature4: {
          section1: 'Earn through',
          section2: 'LP rewards',
          section3: 'maker rebates',
          section4: 'fee discounts',
          section5: 'by staking INJ.'
        },
        feature5: {
          section1: 'Benefit from a smooth trading flow with',
          section2: 'auto-signing',
          section3: 'and a gas-free experience.'
        },
        feature6: {
          section1: 'Participate in frequent',
          section2: 'trading competitions',
          section3: 'and unlock exclusive rewards.'
        }
      },
      accordion3: {
        title: 'How do I get started with Helix?',
        content1:
          'To start trading on Helix, simply log in using your social account or connect your wallet, then deposit your assets.',
        content2:
      ...
      accordion4: {
        ...
        option1: {
          section1: 'Buy crypto via',
          section2: 'fiat on-ramps',
          section3:
            '(through debit/credit cards, Revolut, Apple Pay, Google Pay & more).'
        },
        option2: {
          section1: 'Use',
          section2: 'Injective Bridge',
      ...
      accordion5: {
        ...
        step1: {
          ...
          section3: 'and connect your wallet.'
        },
        step2: {
          section1: 'Deposit or bridge assets like',
          section2: 'USDT',
          section3: 'INJ'
        },
        step3: {
          ...
          section2: 'Spot',
          section3: 'Perpetual',
          section4: 'market you want to trade.'
        },
        step4: {
          section1: 'Place a',
          section2: 'limit',
          section3: 'market order',
      ...
      accordion6: {
        ...
        option1: {
          section1: 'Trading Competitions',
          section2: 'Join to win real prizes and rank on leaderboards.'
        },
        option2: {
          section1: 'Referral Program',
          section2:
            'Invite friends and earn up to 40% of your referrals’ fees as rewards.'
        },
        option3: {
          section1: 'Staking & Yields',
          section2: 'Stake INJ or deposit USDT for passive rewards.'
        },
        option4: {
          section1: 'Liquidity Incentives',
          section2: 'Participate in campaigns like',
          section3: 'LP Rewards',
          section4: 'and earn weekly rewards.'
        }
      }
    }
  },
