  ...
  <div class="container py-16">
    <div class="w-full mx-auto 3xl:w-11/12 4xl:w-10/12 relative">
      ...
      <p class="font-semibold mt-2">
        <span>Last updated: 09.21.2023</span>
      </p>
      ...
      <p class="mt-4">
        ...
        access to, Injective&rsquo;s websites, including www.injectivelabs.org
        and www.helixapp.com, web applications, mobile applications, all
        associated sites and interfaces linked thereto by Injective or its
        affiliates, application programming interfaces (&ldquo;APIs&rdquo;) and
      ...
      <p class="mt-4">
        ...
        Site and access to any and all functionality provided through or
        ...
        disclaimers and limitations of legal liability, relating to your use of,
      ...
      <p class="mt-4">
        ...
        about the legal obligations associated with your use of the Services. By
        accessing or using the Site or the Services, you understand and agree
      ...
      <p class="mt-4">
        <span>
          We reserve the right, in our sole discretion, to modify these Terms
          from time to time. If we make changes, we will provide you with notice
          of such changes, such as by providing notice through the Services or
          updating the &ldquo;Last Updated&rdquo; date at the top of these
          Terms. Unless we state otherwise in our notice, all such modifications
          are effective immediately, and your continued use of the Site and the
          Services after we provide that notice will confirm your acceptance of
          the changes. If you do not agree to the amended Terms, then you must
          stop using the Site and the Services.
        </span>
      </p>

      <p class="mt-8 font-semibold text-lg"><span>2. USE OF SERVICES</span></p>

      <p class="mt-4">
        <span>
          2.1. As a condition to accessing or using the Services or the Site,
          you represent and warrant to Injective the following:
        </span>
      </p>

      <p class="mt-4">
        <span>
          2.1.1. if you are entering into these Terms as an individual, then you
      ...
      <p class="mt-4">
        <span>
          2.1.9. your access to the Services is not (a) prohibited by and does
          ...
          having jurisdiction over Injective, you, the Site or the Services, or
          as otherwise duly enacted, enforceable by law, the common law or
          equity (collectively, &ldquo;Applicable Laws&rdquo;); or (b)
      ...
      <p class="mt-4">
        <span>
          2.2. As a condition to accessing or using the Services or the Site,
      ...
      <p class="mt-4">
        <span>
          2.2.1. from time to time the Site and the Services may be inaccessible
          or inoperable for any reason, including, without limitation: (a)
          equipment malfunctions; (b) periodic maintenance procedures or repairs
          that Injective or any of its suppliers or contractors may undertake
          from time to time; (c) causes beyond Injective&rsquo;s control or that
          Injective could not reasonably foresee; (d) disruptions and temporary
          or permanent unavailability of underlying blockchain infrastructure,
          including disruptions or unavailability caused by malicious actors or
          decentralized code failure; or (e) unavailability of third-party
      ...
      <p class="mt-4">
        <span>
          2.2.2. we reserve the right to disable or modify access to the Site
      ...
      <p class="mt-4">
        <span>
          2.2.3. the Site and the Services may evolve, which means Injective may
          apply changes, replace, or discontinue (temporarily or permanently)
      ...
      <p class="mt-4">
        <span>
          ...
          available on the Site, do not represent an offer, a solicitation of an
          offer, or any advice regarding, or recommendation to enter into, a
          transaction with Injective or any other person;
        </span>
      </p>

      <p class="mt-4">
        <span>
          2.2.5. Injective does not act as an agent, broker, advisor, or in any
          other capacity for you or any other user of the Site or the Services;
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          ...
          blockchain-based assets (collectively, &ldquo;Digital Assets&rdquo;);
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          2.2.8. to the fullest permitted by Applicable Law, we owe no fiduciary
      ...
      <p class="mt-4">
        <span>
          2.2.9. you are solely responsible for reporting and paying any taxes
      ...
      <p class="mt-4">
        ...
        exist at law or in equity, you hereby irrevocably disclaim, waive, and
        eliminate those duties and liabilities. &nbsp;You further agree to
        indemnify and hold us harmless for any and all claims related to any
        Helix auction in which you participate as a seller of tokens.
        &nbsp;Further, we do not guarantee that any auction in which you
        participate as a seller of tokens will result in a certain amount of
        tokens being purchased, or any tokens being purchased. &nbsp;Further, we
        reserve the right to cancel any auction, for any reason and at any time,
        and we shall have no obligation or liability to you for doing so.
      </p>
      <p class="mt-4">
        2.5 &nbsp;Auctions; Buyers. &nbsp;If you choose to use Helix to purchase
        tokens at auction, you agree to be bound by these Terms. &nbsp;To the
        fullest extent permitted by Applicable Law, we owe no fiduciary duties
        or liabilities to you or any other party, and that to the extent any
        such duties or liabilities may exist at law or in equity, you hereby
        irrevocably disclaim, waive, and eliminate those duties and liabilities.
        &nbsp;You further agree to indemnify and hold us harmless for any and
        all claims related to any Helix auction in which you participate as a
        buyer of tokens. &nbsp;Further, we do not guarantee that any auction in
        which you participate as a buyer of tokens will result in a certain
        amount of tokens being purchased or delivered to you, or any tokens
        being purchased or delivered to you. &nbsp;Further, we reserve the right
        to cancel any auction, for any reason and at any time, and we shall have
        no obligation or liability to you for doing so.
      </p>
      ...
      <p class="mt-4">
        <span>
          ...
          to, and do not, create or impose any fiduciary duties on us.
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          You understand and agree that you may not use the Services to engage
          in the categories of activities set forth below (&ldquo;Prohibited
          Uses&rdquo;):
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          5.1. violate any Applicable Laws including, without limitation, any
          ...
          the Bank Secrecy Act and the US Department of Treasury&rsquo;s Office
      ...
      <p class="mt-4">
        <span>
          ...
          violate any copyright or trademark, (b) the use of Injective&rsquo;s
          intellectual property, name, or logo, including use of
          Injective&rsquo;s trade or service marks, without express consent from
          Injective or in a manner that otherwise harms Injective; or (c) any
      ...
      <p class="mt-4">
        <span>
          5.4. circumvent any content-filtering techniques, security measures or
          access controls that Injective employs on the Site, including, without
      ...
      <p class="mt-4">
        <span>
          5.5. use any robot, spider, crawler, scraper, or other automated means
          or interface not provided by us, to access the Services or to extract
          data, or introduce any malware, virus, Trojan horse, worm, logic bomb,
      ...
      <p class="mt-4">
        <span>
          5.6. provide false, inaccurate, or misleading information while using
          the Site or the Services or engage in activity that operates to
          defraud Injective, other users of the Services, or any other person;
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          5.9. use the Site or the Services from a jurisdiction that we have, in
          our sole discretion, determined is a jurisdiction where the use of the
          Site or the Services is prohibited;
        </span>
      </p>
      ...
      <p class="mt-8 font-semibold text-lg"><span>6. CONTENT</span></p>
      ...
      <p class="mt-4">
        <span>
          ...
          to use, copy, modify, create derivative works of, display, perform,
          publish and distribute, in any form, medium, or manner, any content
          that is available to other users as a result of your use of the Site
          or the Services (collectively, &ldquo;Your Content&rdquo;), including,
          without limitation, for promoting Injective, its affiliates, the
          Services or the Site. You represent and warrant that (a) you own Your
          Content or have the right to grant the rights and licenses in these
          Terms; and (b) Your Content and our use of Your Content, as licensed
      ...
      <p class="mt-4">
        <span>
          7.1. The Site and the Services are governed by the most recent version
          of the open-source license commonly known as the &ldquo;The MIT
          License,&rdquo; a copy of which (as it applies to the Site and the
          Services) can be found at https://github.com/InjectiveLabs (as of the
          date these Terms were last updated) and any other applicable licensing
          terms for the Site and the Services in these Terms (collectively, the
          &ldquo;Injective License&rdquo;). You acknowledge that the Site or the
          Services may use, incorporate or link to certain open-source
          components and that your use of the Site or Services is subject to,
          and you will comply with any, applicable open-source licenses that
          govern any such open-source components (collectively,
          &ldquo;Open-Source Licenses&rdquo;). Without limiting the generality
          of the foregoing, you may not (a) resell, lease, lend, share,
          distribute, or otherwise permit any third party to use the Site or the
          Services; (b) use the Site or the Services for time-sharing or service
          bureau purposes; or (c) otherwise use the Site or the Services in a
          manner that violates the Injective License or any other Open-Source
          Licenses.
        </span>
      </p>
      ...
      <p class="mt-4">
        <span>
          7.2. Excluding the open-source software described in Section 7.1 or
          third-party software that the Site or the Services incorporates, as
          between you and Injective, Injective owns the Site and the Services,
      ...
      <p class="mt-8 font-semibold text-lg"><span>8. LINKS</span></p>
      ...
      <p class="mt-4">
        <span>
          ...
          acknowledge and agree that Injective is not responsible for the
          ...
          sites or resources. You further acknowledge and agree that Injective
      ...
      <p class="mt-4">
        <span>
          ...
          law or by its nature should survive: Sections 7 through 17.
        </span>
      </p>

      <p class="mt-8 font-semibold text-lg"><span>10. RISKS</span></p>

      <p class="mt-4">
        <span>
          10.1. By utilizing the Services or interacting with the Site in any
          way, you represent and warrant that you understand the inherent risks
          associated with cryptographic systems and blockchain-based networks
          (including, without limitation, sudden changes in operating rules,
          such as those commonly referred to as &ldquo;forks,&rdquo; and
      ...
      <p class="mt-4">
        <span>
          10.2. The Services and your Digital Assets could be impacted by one or
          more regulatory inquiries or regulatory actions, which may require us
          to, upon request by government agencies, take certain actions or
          provide information, which may not be in your best interest or could
          impede or limit the ability of Injective to continue to make available
          its proprietary software and, thus, could impede or limit your ability
      ...
      <p class="mt-4">
        <span>
          10.4. Although we intend to provide accurate and timely information on
      ...
      <p class="mt-4">
        <span>
          ...
          Site and the Services at your own risk. The risk of loss in trading
          Digital Assets, especially when trading on margin, can be substantial.
          ...
          resources. By using the Services, you represent and warrant that you
          have been, are, and will be solely responsible for making your
          independent appraisal and investigations into the risks of a given
          transaction and the underlying Digital Assets, including any margin.
          You represent that you have sufficient knowledge, market
          sophistication, professional advice, and experience to make your
          evaluation of the merits and risks of any transaction conducted in
          connection with the Services or any Digital Asset. You accept all
          consequences of using the Services, including the risk that you may
          lose access to your Digital Assets indefinitely. All transaction
          decisions are made solely by you. Notwithstanding anything in these
          Terms, we accept no responsibility whatsoever for, and will in no
          circumstances be liable to you in connection with, your use of the
          Services for performing Digital Asset transactions, including entering
      ...
      <p class="mt-4">
        <span>
          ...
          whether known or unknown to you, against Injective, its affiliates,
      ...
      <p class="mt-8 font-semibold text-lg"><span>11. INDEMNIFICATION</span></p>

      <p class="mt-4">
        <span>
          You will defend, indemnify, and hold harmless Injective, its
          affiliates, and its affiliates&rsquo; respective stockholders,
          members, directors, officers, managers, employees, attorneys, agents,
          representatives, suppliers, and contractors (collectively,
          &ldquo;Indemnified Parties&rdquo;) from any claim, demand, lawsuit,
          ...
          fees, arising out of or relating to (a) your use of, or conduct in
          connection with, the Site or the Services; (b) Digital Assets
          associated with your blockchain address or wallet for which you are
          the/a beneficial owner; (c) any feedback or user content you provide
          to Injective, if any, concerning the Site or the Services; (d) your
          violation of these Terms; or (e) your infringement or misappropriation
          of the rights of any other person or entity. If you are obligated to
          indemnify any Indemnified Party, Injective (or, at its discretion, the
      ...
      <p class="mt-4">
        <span>
          12.2. You understand that Injective is not registered or licensed by
          the US Commodity Futures Trading Commission, the US Securities and
          Exchange Commission, or any financial regulatory authority. No
          financial regulatory authority has reviewed or approved the use of the
          Injective-developed open-source software. The Site and the
      ...
      <p class="mt-4">
        <span>
          12.4. To the maximum extent permitted under Applicable Law, the Site
      ...
      <p class="mt-4">
        <span>
          12.6. The disclaimer of implied warranties contained herein may not
      ...
      <p class="mt-4">
        <span>
          In no event shall Injective, its affiliates, its suppliers and
          contractors, and its affiliates&rsquo;, suppliers&rsquo; and
          contractors&rsquo; respective stockholders, members, directors,
          officers, managers, employees, attorneys, agents, representatives,
          suppliers, and contractors (collectively, the &ldquo;Risk Limited
          Parties&rdquo;) be liable for any incidental, indirect, special,
          ...
          data, information, revenue, opportunities, use, goodwill, profits or
      ...
      <p class="mt-4">
        <span>
          In no event shall Injective&rsquo;s aggregate liability (together with
          its affiliates, including its and its affiliates&rsquo; respective
      ...
      <p class="mt-4">
        <span>
          15.1. Please read the following section carefully because it requires
          you to arbitrate certain disputes and claims with Injective and limits
          how you can seek relief from Injective. PLEASE NOTE THAT ARBITRATION
      ...
      <p class="mt-4">
        <span>
          15.3. YOU AND INJECTIVE WAIVE YOUR RIGHTS TO A JURY TRIAL AND TO HAVE
          ANY DISPUTE ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICES
          RESOLVED IN COURT. Instead, for any dispute or claim that you have
          against Injective or relating in any way to the Services, you agree to
          first contact Injective and attempt to resolve the claim informally by
          sending a written notice of your claim (&ldquo;Notice&rdquo;) to
          Injective by email at legal@injectivelabs.org. The Notice must (a)
          ...
          forth the specific relief sought. Our notice to you will be similar in
          form to that described above. If you and Injective cannot reach an
          ...
          binding arbitration administered by JAMS. All disputes submitted to
          JAMS will be resolved through confidential, binding arbitration before
          one arbitrator. Arbitration proceedings will be held in New York, New
          York, under the JAMS Streamlined Arbitration Rules and Procedures
          (&ldquo;JAMS Rules&rdquo;). The most recent version of the JAMS Rules
      ...
      <p class="mt-4">
        <span>
          15.5. You and Injective agree that for any arbitration you initiate,
          you will pay the filing fee and all other JAMS fees and costs. For any
          arbitration initiated by Injective, Injective will pay all JAMS fees
          and costs. You and Injective agree that the state or federal courts of
          the State of New York and the United States sitting in New York, New
      ...
      <p class="mt-4">
        <span>
          ...
          Injective will not have the right to assert the claim.
        </span>
      </p>

      <p class="mt-4">
        <span>
          15.7. If any portion of this Section 15 is found to be unenforceable
          or unlawful for any reason, (a) the unenforceable or unlawful
          provision shall be severed from these Terms; (b) severance of the
          unenforceable or unlawful provision shall have no impact whatsoever on
          the remainder of this Section 15 or the parties&rsquo; ability to
          compel arbitration of any remaining claims on an individual basis
          under this Section 15; and (c) to the extent that any claims must
          ...
          of this Section 15 is found to prohibit an individual claim seeking
          public injunctive relief, then that provision will have no effect to
          the extent such relief is allowed to be sought out of arbitration, and
          the remainder of this Section 15 will be enforceable.
        </span>
      </p>

      <p class="mt-8 font-semibold text-lg"><span>16. GOVERNING LAW</span></p>

      <p class="mt-4">
        <span>
          The interpretation and enforcement of these Terms, and any dispute
          related to these Terms, the Site or the Services, will be governed by
          and construed and enforced under the laws of the State of New York, as
          ...
          would cause the application of the laws of any other jurisdiction. You
          agree that we may initiate a proceeding related to the enforcement or
          validity of our intellectual property rights in any court having
          jurisdiction. For any other proceeding that is not subject to
          arbitration under these Terms, the state and federal courts located in
          New York, New York will have exclusive jurisdiction. You waive any
      ...
      <p class="mt-4">
        <span>
          17.1. Please refer to our privacy policy, which is incorporated herein
          by reference and available here at
          https://injectivelabs.org/privacy-policy, for information about how we
      ...
      <p class="mt-4">
        <span>
          ...
          (collectively, our &ldquo;Communications&rdquo;) that we provide in
          ...
          concerning the Services at legal@injectivelabs.org.
        </span>
      </p>

      <p class="mt-4">
        <span>
          17.3. Any right or remedy of Injective set forth in these Terms is in
          ...
          The failure or delay of Injective in exercising any right, power, or
      ...
      <p class="mt-4">
        <span>
          17.4. The invalidity or unenforceability of any of these Terms shall
      ...
      <p class="mt-4">
        <span>
          17.5. Headings of sections are for convenience only and shall not be
      ...
      <p class="mt-4">
        <span>
          ...
          Injective and supersede all prior and contemporaneous understandings
          between the parties regarding the Site and the Services.
        </span>
      </p>

      <p class="mt-4">
        <span>
          17.7. In the event of any conflict between these Terms and any other
      ...
      <p class="mt-4">
        <span>
          A non-US affiliate of Injective accesses and uses the Services in the
