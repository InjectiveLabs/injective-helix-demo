...
!(function (e, t) {
  ...
  var i =
    ((s.prototype.getBars = function (e, t, r, s) {
      var o = this,
  ...
  var h =
    ((f.prototype.resolveSymbol = function (t) {
      var r = this
  ...
  var m =
    ((b.prototype.onReady = function (e) {
      var t = this
    ...
    (b.prototype.calculateHistoryDepth = function (e, t, r) {}),
    (b.prototype.getMarks = function (e, t, r, s, o) {
  ...
  var P =
    ((q.prototype.sendRequest = function (e, t, r) {
      if (void 0 !== r) {
        var s = Object.keys(r)
        0 !== s.length && (t += '?'),
          (t += s
  ...
  var w,
    ...
    x =
      (t((D = k), (S = w = m)),
      (D.prototype =
        null === S ? Object.create(S) : ((U.prototype = S.prototype), new U())),
      k)
  function U() {
    this.constructor = D
  }
  function k(e, t) {
    ...
    var r = new P(),
      s = new v(e, r)
    return w.call(this, e, s, r, t) || this
  }
  ;(e.UDFCompatibleDatafeed = x),
