...
export enum SpotMarketCyTags {
  ...
  EnoughLiquidity = 'enough-liquidity',
  ...
  CalculatedNotional = 'calculated-notional',
  ...
  MinimumAmountInQuote = 'minimum-amount-in-quote',
  ...
  DisplayedEstimatedSlippage = 'displayed-estimated-slippage',
  DisplayedSlippageTolerance = 'displayed-slippage-tolerance',
  OpenOrderTotalAmtTokenSymbol = 'open-order-total-amt-token-symbol',
  IsNotionalLessThanMinNotional = 'is-notional-less-than-min-notional',
...
export enum PerpetualMarketCyTags {
  ...
  TpSlUpdateButton = 'tpsl-update-button',
