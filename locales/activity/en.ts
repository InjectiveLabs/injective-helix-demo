export default {
  ...
  walletHistory: {
    ...
    axelarDepositType: 'Axelar to INJ Chain',
    chihuahuaDepositType: 'Chihuahua to INJ Chain',
    cosmosDepositType: 'Cosmos to INJ Chain',
    junoDepositType: 'Juno to INJ Chain',
    osmosisDepositType: 'Osmosis to INJ Chain',
    terraDepositType: 'Terra to INJ Chain',
    ethWithdrawalType: 'INJ Chain to ETH',
    axelarWithdrawalType: 'INJ Chain to Axelar',
    chihuahuaWithdrawalType: 'INJ Chain to Chihuahua',
    cosmosWithdrawalType: 'INJ Chain to Cosmos',
    junoWithdrawalType: 'INJ Chain to Juno',
    osmosisWithdrawalType: 'INJ Chain to Osmosis',
    terraWithdrawalType: 'INJ Chain to Terra',
