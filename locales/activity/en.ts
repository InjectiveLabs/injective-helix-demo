export default {
  ...
  walletHistory: {
    ...
    INJTransferType: 'Injective Chain to Injective Chain',
    ethDepositType: 'Ethereum to Injective Chain',
    axelarDepositType: 'Axelar to Injective Chain',
    chihuahuaDepositType: 'Chihuahua to Injective Chain',
    cosmosDepositType: 'Cosmos Hub to Injective Chain',
    junoDepositType: 'Juno to Injective Chain',
    osmosisDepositType: 'Osmosis to Injective Chain',
    terraDepositType: 'Terra to Injective Chain',
    ethWithdrawalType: 'Injective Chain to Ethereum',
    axelarWithdrawalType: 'Injective Chain to Axelar',
    chihuahuaWithdrawalType: 'Injective Chain to Chihuahua',
    cosmosWithdrawalType: 'Injective Chain to Cosmos Hub',
    junoWithdrawalType: 'Injective Chain to Juno',
    osmosisWithdrawalType: 'Injective Chain to Osmosis',
    terraWithdrawalType: 'Injective Chain to Terra',
