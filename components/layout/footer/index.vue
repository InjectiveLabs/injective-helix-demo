<template>
  ...
  >
    ...
    >
      ...
      <item class="text-footer">
        <nuxt-link v-if="false" class="cursor-pointer" :to="{ name: 'faq' }">
          {{ $t('faq') }}
        </nuxt-link>
      </item>
      <item class="text-footer">
