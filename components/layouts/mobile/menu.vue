<template>
  <div class="ml-4 block lg:hidden relative pt-4">
    <button
      ...
      class="hamburger hamburger--spin outline-none focus:outline-none block lg:hidden"
      type="button"
    ...
    <div
      ...
      class="absolute flex justify-center border flex-wrap top-0 left-0 mr-0 min-w-2xs -ml-4 right-0 mt-12 rounded rounded-tl-none bg-dark-700 shadow-md"
    >
