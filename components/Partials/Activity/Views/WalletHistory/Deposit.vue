...
const transferType = computed(() => {
  if (props.transaction.sender.startsWith('axelar')) {
    return t('walletHistory.axelarDepositType')
  }

  if (props.transaction.sender.startsWith('chihuahua')) {
    return t('walletHistory.chihuahuaDepositType')
  }

  if (props.transaction.sender.startsWith('cosmos')) {
    return t('walletHistory.cosmosDepositType')
  }

  if (props.transaction.sender.startsWith('juno')) {
    return t('walletHistory.junoDepositType')
  }

  if (props.transaction.sender.startsWith('osmo')) {
    return t('walletHistory.osmosisDepositType')
  }

  if (props.transaction.sender.startsWith('terra')) {
    return t('walletHistory.terraDepositType')
  }

  if (props.transaction.sender.startsWith('evmos')) {
    return t('walletHistory.evmosDepositType')
  }
  ...
  return t('walletHistory.ethDepositType')
})
