...
<template>
  ...
  >
    ...
    >
      <PartialsActivityViewsPositionsTableFundingPaymentMobile
    ...
    <CommonTableWrapper break-md class="hidden sm:block">
      <table v-if="fundingPayments.length > 0" class="table h-full">
        <PartialsActivityViewsPositionsTableFundingPaymentHeader />
        <tbody>
          <PartialsActivityViewsPositionsTableFundingPaymentRow
            v-for="(fundingPayment, index) in fundingPayments"
