...
<template>
  <div class="flex flex-col sm:block">
    <div class="flex items-center justify-start mb-8">
      <AssetLogoText class="block h-8 text-gray-100" />
    </div>
    <h1
      class="text-gray-100 font-bold text-[36px] leading-[58px] sm:text-5xl sm:leading-[60px] 3xl:leading-[72px] 3xl:text-[60px] 4xl:leading-[77px] 4xl:text-[64px] mb-8"
    >
      {{ $t('home.title') }}
    </h1>
    <p class="text-gray-100 mt-4 text-base 3xl:text-xl mb-8">
      {{ $t('home.subtitle') }}
    </p>
    <div class="grid grid-cols-12 gap-4 text-base 3xl:text-xl">
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon name="lightning-fill" class="text-gray-100 w-6 h-6 mr-3" />
        <span class="text-gray-100 text-lg">
          {{ $t('home.fast') }}
        </span>
      </div>
      ...
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon
          ...
          class="text-gray-100 w-6 h-6 mr-3"
        />
        <span class="text-gray-100 text-lg">
      ...
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon name="gas" class="text-gray-100 w-6 h-6 mr-3" />
        <span class="text-gray-100 text-lg">
          {{ $t('home.gasFree') }}
        </span>
      </div>
      ...
      <div class="col-span-6 flex items-center justify-start">
        <BaseIcon name="shield-lock-fill" class="text-gray-100 w-6 h-6 mr-3" />
        <span class="text-gray-100 text-lg">
          {{ $t('home.secure') }}
        </span>
      </div>
