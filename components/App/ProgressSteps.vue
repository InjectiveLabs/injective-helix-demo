  ...
  <div>
    <div class="relative mr-px">
      ...
      <div class="flex justify-between">
        <div
          ...
          :class="[
            dot > activeStep ? 'border-gray-500' : 'border-blue-500',
            {
              'progressing-dot':
        ...
        >
          <div
            v-if="dot <= activeStep"
            class="border-blue-500 bg-blue-500 h-full w-full rounded-full"
          />
        </div>
      </div>
      <!-- lines -->
      <div class="absolute flex justify-between items-center w-full inset-y-0">
        <div
          ...
          :class="{
            'ml-4': line === 1,
            'mr-4': line + 1 === steps,
            'bg-gradient-to-r from-blue-500 to-blue-200': line < activeStep,
    ...
    >
      <span
        ...
        :class="{
          'text-blue-500': activeStep - 1 >= index,
...
.progressing-dot::before {
  @apply border-blue-500 border border-4 h-4 w-4 absolute rounded-full;
