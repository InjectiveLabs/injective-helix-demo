<template>
  <div class="h-full flex flex-col">
    <div class="flex items-center justify-center">
      <v-button-select v-model="component" data-cy="activity-spot-orders-link" :option="components.orders" text>
        {{ $t('activity.openOrders') }}
      </v-button-select>
      <div class="mx-2 w-px h-4 bg-gray-500"></div>
      <v-button-select v-model="component" data-cy="activity-spot-trades-link" :option="components.trades" text>
